...
import org.example.kafkauser.common.annotation.trace.util.TraceUtil;
...
public class TraceOutboxKafkaAspect {
     ...
     * @throws Throwable - 예외
     */
    @Around(value = "@annotation(org.example.kafkauser.common.annotation.trace.TraceOutboxKafka) && " +
    ...
    public Object traceKafkaListener(
        ...
        Span span = tracer.spanBuilder("Member [kafka-consume] outbox process change [PROCESSED]")
